...
"""
Custom scanner plugin for Plex Media Server for {tv root}/{show name}/Season {season}/{episode} {episode name}.{ext} file naming scheme
"""

import sys

# I needed some plex libraries, you may need to adjust your plex install location accordingly
sys.path.append("/var/db/plexdata/Plex Media Server/Scanners/Series")
sys.path.append("/usr/pbi/plexmediaserver-amd64/share/plexmediaserver/Resources/Plug-ins-a39b25852/Scanners.bundle/Contents/Resources/Common")
